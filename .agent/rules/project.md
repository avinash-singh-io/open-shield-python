...
- If on `main` or `staging`, **auto-create a feature branch** before making changes:
  - Phase work: `phase-N-shortname` (e.g., `phase-5-flask-django`)
  - Bug fix: `fix/BUG-NNN-short-desc` (e.g., `fix/BUG-001-jwks-cache`)
  - Feature: `feat/short-desc` (e.g., `feat/opa-integration`)
